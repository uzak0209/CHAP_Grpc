...
const file_thread_proto_rawDesc = "" +
	...
	"\tthread_id\x18\x01 \x01(\tR\bthreadId2\xf7\x04\n" +
	"\rThreadService\x12\x82\x01\n" +
	"\x0eGetThreadsByID\x12$.chap.thread.v1.GetThreadByIDRequest\x1a%.chap.thread.v1.GetThreadByIDResponse\"#\x82\xd3\xe4\x93\x02\x1d\x12\x1b/api/v1/threads/{thread_id}\x12o\n" +
	"\n" +
	"GetThreads\x12!.chap.thread.v1.GetThreadsRequest\x1a\".chap.thread.v1.GetThreadsResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*\"\x0f/api/v1/threads\x12x\n" +
